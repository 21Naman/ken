import type { Approval, AuditEvent, Budget, CapturePreview, CookProfile, DemoResetResponse, DishHistory, HealthResponse, Household, InventoryLot, Leftover, MealLoop, Member, PlanResponse, Preference } from "./contracts";
...
export const api = {
  health: () => request<HealthResponse>("/api/health"), resetDemo: (scenario = "default") => request<DemoResetResponse>(`/api/demo/reset?scenario=${encodeURIComponent(scenario)}`, { method: "POST" }),
