...
export interface DemoResetResponse { status: "reset"; scenario: string; recipes: number; store_items: number; household_id: number; }
...
export interface InventoryLot { id: number; ingredient: string; quantity: number; unit: string; expiry_date: string | null; storage_location: string; confirmed: boolean; expiry_status: string; }
...
export interface CaptureCandidate { ingredient: string; quantity: number; unit: string; expiry_date: string | null; storage_location: string; readability_confidence: number; }
